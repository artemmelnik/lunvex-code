...
This guide explains how to publish LunVex Code to PyPI for easier installation.

本指南说明如何将 LunVex Code 发布到 PyPI 以便更轻松地安装。

---

## Why PyPI? | 为什么选择 PyPI?

- **Easier installation**: `pip install lunvex-code` instead of `pip install git+...`
...
This creates:
- `dist/lunvex_code-0.1.0-py3-none-any.whl`
- `dist/lunvex_code-0.1.0.tar.gz`
...
pip install lunvex-code==0.1.0

# Upgrade
pip install --upgrade lunvex-code
```
