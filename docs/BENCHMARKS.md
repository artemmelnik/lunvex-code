...
This document provides benchmark comparisons between LunVex Code and other AI coding assistants.

本文档提供 LunVex Code 与其他 AI 编程助手的性能对比。

---

## Cost Comparison | 成本对比

| Metric | LunVex Code | Claude Code | Cursor | GitHub Copilot |
|--------|---------------|-------------|--------|----------------|
...
|------|------------------|
| LunVex Code | ~$0.008 (0.5¢) |
| Claude Code | ~$1.25 |
| Cursor | $0.67 (portion of $20) |
| GitHub Copilot | $0.33 (portion of $10) |

**LunVex Code is approximately 100x cheaper than Claude Code for equivalent work.**
...
| Task Type | LunVex Code | Claude Code |
|-----------|---------------|-------------|
...
| Operation | LunVex Code | Claude Code |
|-----------|---------------|-------------|
| First Response | ~1.2s | ~1.5s |
| Tool Execution | ~0.3s | ~0.4s |
| Full Task (avg) | ~8s | ~10s |

*Note: Speed tests conducted on identical hardware with LunVex-V3 API.*
...
| Metric | LunVex Code | Claude Code |
|--------|---------------|-------------|
...
| Feature | LunVex Code | Claude Code |
|---------|---------------|-------------|
| Interactive REPL | ✅ | ✅ |
| File Editing | ✅ | ✅ |
| Shell Commands | ✅ | ✅ |
