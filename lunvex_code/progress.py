...
class BaseProgressIndicator(ABC):
    ...
    @contextmanager
    def track(self, message: str = "", total: float = 1.0) -> Generator[Callable[[float, str], None], None, None]:
...
class BarProgress(BaseProgressIndicator):
    ...
    def _create_progress(self) -> Progress:
        ...
        columns.append(BarColumn(style=self.config.progress_style, complete_style=self.config.progress_style))
...
class ProgressManager:
    ...
    @contextmanager
    def spinner(self, message: str = "", config: Optional[ProgressConfig] = None) -> Generator[SpinnerProgress, None, None]:
    ...
    @contextmanager
    def bar(self, message: str = "", total: float = 100.0, config: Optional[ProgressConfig] = None) -> Generator[BarProgress, None, None]:
    ...
    @contextmanager
    def multi(self, config: Optional[ProgressConfig] = None) -> Generator[MultiProgress, None, None]:
...
@contextmanager
def spinner(message: str = "", config: Optional[ProgressConfig] = None) -> Generator[SpinnerProgress, None, None]:
...
@contextmanager
def progress_bar(message: str = "", total: float = 100.0, config: Optional[ProgressConfig] = None) -> Generator[BarProgress, None, None]:
