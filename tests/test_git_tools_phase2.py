...
class TestGitAddTool:
    ...
    def test_execute_basic(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git add file.txt"
        )
    ...
    def test_execute_all(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git add --all"
        )
    ...
    def test_execute_multiple_files(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git add file1.txt file2.txt"
        )
...
class TestGitPushTool:
    ...
    def test_execute_with_branch(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git push origin main"
        )
    ...
    def test_execute_with_tags(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git push --tags origin"
        )
    ...
    def test_execute_custom_remote(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git push upstream"
        )
...
class TestGitPullTool:
    ...
    def test_execute_with_rebase(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git pull --rebase origin"
        )
    ...
    def test_execute_with_branch(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git pull origin feature"
        )
    ...
    def test_execute_ff_only(self, mock_run_git):
        ...
        mock_run_git.return_value = GitResult(
            success=True, output="", error=None, exit_code=0, command="git pull --ff-only origin"
        )
