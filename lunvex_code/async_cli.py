...
from .async_agent import AsyncAgent, AsyncAgentConfig
...
async def interactive_loop_async(agent: AsyncAgent) -> None:
    """Run the interactive REPL loop asynchronously."""
...
def print_help(agent: AsyncAgent) -> None:
...
def print_status(agent: AsyncAgent) -> None:
...
async def create_and_run_agent_async(
    task: Optional[str],
    model: str,
    trust: bool,
    yolo: bool,
